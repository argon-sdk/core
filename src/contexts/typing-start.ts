...
/** Context for the typing start event */
export class TypingStartContext extends BaseContext {
  ...
  constructor(
    ...
    super(api, eventId, EventType.TypingStart, registerControlHandler, registerSelectHandler, services)
